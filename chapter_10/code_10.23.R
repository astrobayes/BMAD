...
# Data from  Code 10.22 - Normal autoregressive model AR(1) for accessing the evolution of the number
...
# Code 10.23 - Negative binomial model (AR1) for assessing the evolution of the number of
...
# Run mcmc
jagsfit <- jags(data = sun_data, inits = inits, parameters = params, model = textConnection(AR1_NB),
                n.thin = 1, n.chains=3,n.burnin=5000,n.iter = 10000)
